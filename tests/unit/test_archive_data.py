...
def test_people_rows_rename_replaces_internal_id_in_summary():
    ...
    face_clustering = {
        ...
        "cluster_identities": {"Person_01": {"name": "Dawn McNeill"}},
    }
    ...
    assert rows[0]["summary"] == "Photos capture Dawn McNeill in various everyday settings."
...
def test_correspondent_duplicate_candidates_surfaces_real_person_not_bulk_sender():
    # "Dawn McNeill" across 2 personal domains, bidirectional → a real candidate.
    ...
    freq = [
        {"address": "dawn@yahoo.com", "display_name": "Dawn McNeill", "total": 100,
         "bidirectional": True},
        {"address": "dawn.mcneill@gmail.com", "display_name": "Dawn McNeill", "total": 50,
         "bidirectional": True},
    ...
    assert names == ["Dawn McNeill"], "bulk single-domain sender excluded; lone address excluded"
    c = cands[0]
    assert c["total_combined"] == 150
    assert [a["address"] for a in c["addresses"]] == ["dawn@yahoo.com", "dawn.mcneill@gmail.com"]
